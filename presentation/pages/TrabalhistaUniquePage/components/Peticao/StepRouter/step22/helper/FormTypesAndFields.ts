...
export type Action =
    ...
    | { type: 'ADD_ASSINANTE'; field: FormField.ASSINANTES; value: advogado_assinante }
    | { type: 'EDIT_ASSINANTE'; field: FormField.ASSINANTES; value: advogado_assinante[] }
    | { type: 'DELETE_ASSINANTE'; field: FormField.ASSINANTES; value: advogado_assinante[] }
    | { type: 'RESET' }
