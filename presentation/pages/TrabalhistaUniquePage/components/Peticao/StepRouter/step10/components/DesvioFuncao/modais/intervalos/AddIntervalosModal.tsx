...
import { formReducer, getErrorInitialState, getFormInitialState } from './DesviosReducerFunctions';
...
interface IModal {
    open: boolean
    onClose: () => void
    onAdicionarClick: (intervalo: intervalo) => void
}

export function AddDesviosModal(props: IModal) {
    ...
    return (
        <AddModal
            title='Desvio de Função | Cadastrar Intervalo de data'
            open={open}
            onClose={onClose}
