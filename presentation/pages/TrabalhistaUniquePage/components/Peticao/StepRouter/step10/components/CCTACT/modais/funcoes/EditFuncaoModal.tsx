...
import { formReducer, getEditFormInitialState, getErrorInitialValue, getFormInitialState } from './FuncoesReducerFunctions'
...
interface IModal {
    open: boolean
    onClose: () => void
    onEditarClick: (id: string, funcao: funcao) => void
    funcao: funcao
}

export default function EditFuncaoModal(props: IModal) {
    const { open, onClose, onEditarClick, funcao } = props
    const [state, dispatch] = useReducer(formReducer, getEditFormInitialState(funcao))
