...
import TrabalhistaStepRouter from './StepRouter/StepRouter'

export default function Peticao({ ticketUnique: api_data, regraDominio }: TrabalhistaProps) {
    return (
        <Accordion>
            <AccordionSummary
            ...
            <Accordion expanded>
                <TrabalhistaStepRouter api_data={api_data} />
            </Accordion>
        </Accordion>
    )
}
