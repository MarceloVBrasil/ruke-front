...
import { createContract, createHipossuficiencia } from '@/app/api/client/documents';
import axios from 'axios';

export default function DocumentoHipossuficiencia({ ticketUnique: api_data, regraDominio }: SuperEndividamentoProps) {
