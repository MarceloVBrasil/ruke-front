...
import { formReducer, getFormInitialEditState } from './VeiculosReducerFunctions';
import CurrencyInput from '@/presentation/components/CurrencyInput';
import { formatCurrency, onlyNumber } from '@/app/utils/Formater';
import { EditModal } from '@/presentation/components/ModalEdit';
import GridCurrencyInput from '@/presentation/components/GridCurrencyInput';
import GridTextField from '@/presentation/components/GridTextField';
import { isFieldEmpty, isAnoValid, isPositive, isRenavamValid } from '@/app/utils/validators';
import { getGridCurrencyInputValue } from '@/app/utils/getSetGridCurrencyInputValue';

interface IModal {
    open: boolean
    onClose: () => void
    onEditarClick: (id: string, veiculo: veiculo) => void
    veiculo: veiculo
}

export function EditVeiculoModal(props: IModal) {
    const { open, onClose } = props
    const [state, dispatch] = useReducer(formReducer, getFormInitialEditState(props.veiculo));
