...
export default function Left() {
    ...
    return (
        <article className='right_border left_border' style={{ marginTop: 0, paddingTop: 0, paddingBottom: 46, marginBottom: 0, paddingRight: 10, display: 'flex', flexDirection: 'column', maxWidth: 545, width: '100%' }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, marginTop: 23, maxWidth: 390, minHeight: 510 }}>
            ...
            <Box className='footer_border' sx={{ position: 'absolute', bottom: { xs: -1100, sm: -110 }, width: '100%', marginInline: 'auto' }}>
